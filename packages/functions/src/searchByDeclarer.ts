...
export const searchByDeclarer = ApiHandler(async (_evt) => {
  console.log("searchByDeclarer called: ");
  ...
  console.log(`searchByDeclarer iscc in vector index : ${iscc}`);
  ...
  const filteredUnderThreshold = vectorResults.filter((v) => v.score < 16);
  ...
  console.log(
    "searchByDeclarer results: (valid)",
  ...
  console.log("searchByDeclarer redactedProductQueryMap: ", areRedactedProductMap);
  ...
  console.log("searchByDeclarer redactedQueryMap: ", areRedactedMap);
  ...
  console.log("will return searchByDeclarer:", willReturn);
